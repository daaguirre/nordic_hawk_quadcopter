...
struct bmp280_t {
	...
	int8_t (*read_reg)(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *data);/**< bus read function pointer*/
	bool (*write_reg)(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t* data);/**< bus write function pointer*/
 ...
 *
 *	@param v_uncomp_temperature_int32_t : The uncompensated temperature.
 *
 *
 *
 *	@return results of bus communication function
 ...
 *
 *
 *  @param v_uncomp_temperature_int32_t : value of uncompensated temperature
 *
 *
 *
 ...
 *
*/
int32_t bmp280_compensate_temperature_int32(int32_t v_uncomp_temperature_int32_t);
/**************************************************************/
 ...
 *
*/
uint32_t bmp280_compensate_pressure_int32(int32_t v_uncomp_pressure_int32_t);
/**************************************************************/
 ...
 *
 * @param  v_uncomp_pressure_int32_t: The value of uncompensated pressure.
 * @param  v_uncomp_temperature_int32_t: The value of uncompensated temperature.
 *
 *  @return results of bus communication function
 *	@retval 0 -> Success
 *	@retval -1 -> Error
...
BMP280_RETURN_FUNCTION_TYPE bmp280_read_uncomp_pressure_temperature(
		int32_t *v_uncomp_pressure_int32_t, int32_t *v_uncomp_temperature_int32_t);
/**************************************************************/
 ...
 *
 *
 *  @param  v_pressure_uint32_t : The value of compensated pressure.
 *  @param  v_temperature_int32_t : The value of compensated temperature.
 *
 *
 *  @return results of bus communication function
 *	@retval 0 -> Success
...
BMP280_RETURN_FUNCTION_TYPE bmp280_read_pressure_temperature(
		uint32_t *v_pressure_uint32_t, int32_t *v_pressure_int32_t);
/**************************************************************/
 ...
 *
 *
 *  @param v_value_uint8_t :The value of temperature over sampling
 *
 *
 *
 *  @return results of bus communication function
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_oversamp_temperature(uint8_t *v_value_uint8_t);
/*!
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_oversamp_temperature(uint8_t v_value_uint8_t);
/*!
 *	@brief This API is used to get
 ...
 *
 *
 *  @param  v_value_uint8_t : The value of pressure over sampling
 *
 *
 *
 *  @return results of bus communication function
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_oversamp_pressure(uint8_t *v_value_uint8_t);
/*!
 *	@brief This API is used to set
 *	the pressure oversampling setting in the register 0xF4
 *	bits from 2 to 4
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_oversamp_pressure(uint8_t v_value_uint8_t);
/**************************************************************/
 ...
 *
 *
 *	@param v_power_mode_uint8_t : The value of power mode value
 *  value            |   Power mode
 * ------------------|------------------
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_power_mode(uint8_t *v_power_mode_uint8_t);
/*!
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_power_mode(uint8_t v_power_mode_uint8_t);
/**************************************************************/
 ...
 *
 *
 *	@param v_enable_disable_uint8_t : The spi3 enable or disable state
 *    value    | Description
 *  -----------|---------------
 *     0       | Disable
 *     1       | Enable
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_spi3(uint8_t *v_enable_disable_uint8_t);
/*!
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_spi3(uint8_t v_enable_disable_uint8_t);
/**************************************************************/
 ...
 *
 *
 *	@param v_value_uint8_t : The value of filter coefficient
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_filter(uint8_t *v_value_uint8_t);
/*!
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_filter(uint8_t v_value_uint8_t);
/**************************************************************/
 ...
 *
 *	@param v_standby_durn_uint8_t : The standby duration time value.
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_get_standby_durn(uint8_t *v_standby_durn);
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_standby_durn(uint8_t v_standby_durn_uint8_t);
/**************************************************************/
 ...
 *
 *
 *  @param v_work_mode_uint8_t : The value of work mode
 *   value      |  mode
 * -------------|-------------
 ...
 *
*/
BMP280_RETURN_FUNCTION_TYPE bmp280_set_work_mode(uint8_t v_work_mode_uint8_t);
/**************************************************************/
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_write_register(uint8_t v_addr_uint8_t,
		uint8_t *v_data_uint8_t, uint8_t v_len_uint8_t);
/*!
 * @brief
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_read_register(uint8_t v_addr_uint8_t,
		uint8_t *v_data_uint8_t, uint8_t v_len_uint8_t);
/**************************************************************/
 ...
 *
*/
double bmp280_compensate_temperature_double(int32_t v_uncomp_temperature_int32_t);
/**************************************************************/
 ...
 *
*/
double bmp280_compensate_pressure_double(int32_t v_uncomp_pressure_int32_t);
 ...
 *
*/
uint32_t bmp280_compensate_pressure_int64(int32_t v_uncomp_pressure);
#endif
 ...
 *
 *
 *  @param v_delaytime_uint8_tr: The value of delay time
 *
 *
 *  @return 0
 *
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_compute_wait_time(uint8_t *v_delaytime);
